...
lockValue_C1[this] := __var_2;
// Initialize length of 1-level nested array in lockValue
assume (forall  __i__0_0:Ref ::  ((Length[M_Ref_Ref[lockValue_C1[this]][__i__0_0]]) == (0)));
assume (forall  __i__0_0:Ref ::  (!(Alloc[M_Ref_Ref[lockValue_C1[this]][__i__0_0]])));
call HavocAllocMany();
assume (forall  __i__0_0:Ref ::  (Alloc[M_Ref_Ref[lockValue_C1[this]][__i__0_0]]));
assume (forall  __i__0_0:Ref, __i__0_1:Ref :: {M_Ref_Ref[lockValue_C1[this]][__i__0_0], M_Ref_Ref[lockValue_C1[this]][__i__0_1]} (((__i__0_0) == (__i__0_1)) || ((M_Ref_Ref[lockValue_C1[this]][__i__0_0]) != (M_Ref_Ref[lockValue_C1[this]][__i__0_1]))));
...
var lockValue_C1: [Ref]Ref;
procedure {:public} {:inline 1} foo_C1(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, _address_s43: Ref, _balance_s43: int);
implementation foo_C1(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, _address_s43: Ref, _balance_s43: int)
{
var i_s42: int;
i_s42 := 0;
while ((i_s42) < (M_Ref_int[lockNum_C1[this]][_address_s43]))
{
_balance_s43 := (_balance_s43) + ((M_int_int[M_Ref_Ref[lockValue_C1[this]][_address_s43]][i_s42]));
i_s42 := (i_s42) + (1);
}
}
